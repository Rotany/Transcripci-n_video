...
system_content_anonymize_transcription = (
    ...
    "Además, modifica el texto para que no sea idéntico al del video. ",
    "Quita todos los nombres propios y todo la relacionado con ellos. Puedes añadir contenido nuevo o eliminar partes, siempre respetando la esencia del contenido, que trata sobre cocina o recetas de cocina. ",
